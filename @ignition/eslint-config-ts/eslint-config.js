module.exports = {
  ...
  rules: {
    ...
    'key-spacing': ['error', {singleLine: { beforeColon: false, afterColon: true }, multiLine: { beforeColon: false, afterColon: true }, align: { on: 'colon', beforeColon: true, afterColon: true }}],
